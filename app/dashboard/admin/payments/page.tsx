...
const payments = [
	...
	},
	{
		id: "PAY-004",
		tenant: "Meron Dawit",
		property: "for Subscription Renewal",
		unit: "i want renewal my membership",
		amount: 20000,
		dueDate: "2024-01-01",
		paidDate: "2023-12-30",
		status: "paid",
				...
				<div className="flex items-center justify-between">
					...
					<div className="flex space-x-3">
						...
						{/* <Button asChild className="bg-[#4A90E2] hover:bg-[#2F80ED]">
							<Link href="/dashboard/hq/payments/new">
					...
					<Card>
						<CardContent className="p-4">
							<div className="flex items-center space-x-2">
								...
								<div>
									<p className="text-2xl font-bold">
										{(overdueAmount .toLocaleString())} ETB
									</p>
						...
						<Table>
							<TableHeader>
								<TableRow>
									...
									<TableHead>Payment Case</TableHead>
